...
- ![socket](../assets/img/10-pc_por_piezas/cpu_socket.png "socket cpu")

- Tipo de memoria: DDR4 hasta 3200 MT/s.

- Evidencia (URL): https://www.amd.com/es/support/downloads/drivers.html/processors/ryzen/ryzen-5000-series/amd-ryzen-5-5600gt.html#amd_support_product_spec 

- ![Memoria](../assets/img/10-pc_por_piezas/memoria.png "Memoria")
...
- ![CPU_MB](../assets/img/10-pc_por_piezas/placa_compatibilidad_cpu.png "CPU MB")
...
- ![Memoria_MB](../assets/img/10-pc_por_piezas/placa_compatibilidad_memoria.png "Memoria MB")
...
- ![RAM](../assets/img/10-pc_por_piezas/ficha_ram.png "RAM")
...
- ![Frecuencia_RAM](../assets/img/10-pc_por_piezas/frecuencia_ram.png "Frecuencia RAM")
...
- ![Storage_MB](../assets/img/10-pc_por_piezas/wd-green-SN350.png "Storage MB")
...
- ![Interfaz_PCIe](../assets/img/10-pc_por_piezas/interfazMB_disco.png "Interfaz PCIe")
...
- ![Conectores_PSU](../assets/img/10-pc_por_piezas/conectores_psu.png "Conectores PSU")

- PSU/Caja (Formato): Cumple con el estándar ATX, compatible con el chasis Hiditec seleccionado.

- Evidencia (URL): https://www.gigabyte.com/Power-Supply/GP-P650G/sp 

- ![Factor_Forma_PSU](../assets/img/10-pc_por_piezas/factor-de-forma_psu.png "Factor de Forma PSU")
...
- ![Factor_Forma_Chasis](../assets/img/10-pc_por_piezas/factor_forma_chasis.png "Factor de Forma Chasis")

- Caja/PSU: Admite fuentes de alimentación formato ATX estándar.

- Evidencia (URL): https://hiditec.com/es/mid-tower/11-klyp.html (Ver detalles del producto)

- ![Factor_Forma_PSU_Chasis](../assets/img/10-pc_por_piezas/factor_forma_psu_chasis.png "Factor de Forma PSU del Chasis")
...
- ![Compatibilidad_Disipador](../assets/img/10-pc_por_piezas/compatibilidad_disipador.png "Compatibilidad Disipador")
...
- ![Dimensiones_Disipador](../assets/img/10-pc_por_piezas/dimensiones_disipador.png "Dimensiones Disipador")
